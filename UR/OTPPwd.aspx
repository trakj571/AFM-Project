<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OTPPwd.aspx.cs" Inherits="EBMSMap30.UR.OTPPwd" %>
		...
		<div class="row">
            ...
            <br />
                 <%}%>
                  ...
                  ระบบได้ส่ง SMS รหัส OTP ไปที่โทรศัพท์ของคุณแล้ว โปรดตรวจสอบ และนำมากรอกเพื่อเปลี่ยนรหัสผ่าน
                     <br />
            <br />
             <div class="col-md-12">
				    <div class="afms-field afms-field_input">
						<input id=OTP type=password  runat=server placeholder="">
							    <span class="bar"></span>
                                
								<label>OTP</label>
                        	</div>
                             <asp:RequiredFieldValidator id=rOTP ForeColor="Red" ControlToValidate="OTP" ErrorMessage="* โปรดกรอกรหัส OTP<br /><br />" Runat=server Display=Dynamic></asp:RequiredFieldValidator>
                             </div>
