<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CField.aspx.cs" Inherits="EBMSMap.Web.Admin.CField" %>
                                    ...
                                    <div class="nbtc-row">
										<div class="nbtc-col2">
											<div class="nbtc-field nbtc-field_textarea">
												<textarea id=Options runat=server style="height:100px"></textarea>
												<span class="bar"></span>
												<label>(Options)</label>
											</div>
