<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UGrp.aspx.cs" Inherits="EBMSMap.Web.Admin.UGrp" %>
        ...
        $(function () {
            ...
            $("#CapList").jstree({
                ...
                $('#CapList li').each(function () {
                    ...
                    $("#CapList").jstree().disable_node(this.id);

                })

            });

            <%if (Request["UGID"] == null)
        { %>
...
<body class="nbtc-admin">
    <div class="nbtc-container">
        ...
        <div class="nbtc-sec-breadcrumb">
            ...
            <a href="UGrpAdd.aspx" class="nbtc-btn nbtc-btn-secondary">Add Group Policy</a>
        </div>
                ...
                <div class="nbtc-sec-center nbtc-col2">
                    <div class="nbtc-sec-content content-readonly">
                        ...
                        <div class="nbtc-content-options">
                            <a href='UGrpAdd.aspx?ugid=<%=Request["UgID"] %>' class="nbtc-btn nbtc-ic_edit"></a>
                            <a href="javascript:delItem('spUR_AddUGrp','UgID','<%=Request["UgID"] %>')" class="nbtc-btn nbtc-btn-delete nbtc-ic_delete"></a>
                        </div>
                        ...
                        <div>
                            <p class="nbtc-table-title">User in Group</p>
                                    ...
                                    <%
                                        if (tbU != null)
                                        {
                                            for (int i = 0; i < tbU.Rows.Count; i++)
                                            {
                                                ...
                                                Response.Write("<td>" + tbU.Rows[i]["FName"] + " " + tbU.Rows[i]["LName"] + "</td>");
                                                Response.Write("<td>" + tbU.Rows[i]["Login"] + "<!--(" + tbU.Rows[i]["FName"] + " " + tbU.Rows[i]["LName"] + ")-->" + "</td>");
                                                Response.Write("<td>" + tbU.Rows[i]["Org"] + "</td>");
                        ...
                        <div class="nbtc-group-btn">
                            <a href='UGrpAdd.aspx?ugid=<%=Request["UGID"] %>' class="nbtc-btn nbtc-btn-primary">แก้ไข</a>
                            <a href="javascript:delItem('spUR_AddUGrp','UgID','<%=Request["UgID"] %>')" class="nbtc-btn nbtc-btn-secondary nbtc-btn-delete">ลบ</a>
                        </div>
                    </div>
                </div>
            </form>
