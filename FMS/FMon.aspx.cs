...
{
    public partial class FMon : System.Web.UI.Page
    {
            ...
            if (!Page.IsPostBack)
            {
                for (int i = 0; i < 60; i++)
                {
                    if (i <= 24)
                    {
                        ...
                        MnHr.Items.Add(new ListItem(string.Format("{0:00}", i), i.ToString()));
                    }
                    nMin.Items.Add(new ListItem(string.Format("{0:00}",i),i.ToString()));
                    nSec.Items.Add(new ListItem(string.Format("{0:00}",i), i.ToString()));

                    MnMin.Items.Add(new ListItem(string.Format("{0:00}", i), i.ToString()));
                    MnSec.Items.Add(new ListItem(string.Format("{0:00}", i), i.ToString()));
                }
