    ...
    return this.each(function() {
      ...
      function _buildInputGroup() {
        ...
        if (settings.verticalbuttons) {
          ...
          html = '<div class="bootstrap-touchspin"><button class="' + settings.buttondown_class + ' bootstrap-touchspin-down" type="button">' + settings.buttondown_txt + '</button><span class="input-group-addon bootstrap-touchspin-prefix">' + settings.prefix + '</span><span class="bootstrap-touchspin-postfix">' + settings.postfix + '</span><button class="' + settings.buttonup_class + ' bootstrap-touchspin-up" type="button">' + settings.buttonup_txt + '</button></div>';
        }
