...
namespace EBMSMap30.data
{
    ...
    /// </summary>
    public class dLandSch : IHttpHandler
    {
        DataTable tb;
        ...
        private void ExecDB(HttpContext context)
        {
            ...
            SqlDataAdapter SqlCmd = new SqlDataAdapter("[spLand_Sch]", SqlConn);
            ...
            SqlCmd.SelectCommand.Parameters.Add("@Detail", SqlDbType.NVarChar,50);
            SqlCmd.SelectCommand.Parameters["@Detail"].Value = context.Request["detail"];
