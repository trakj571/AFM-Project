...
(function (window, document, undefined) {
    ...
    */
    ...
    L.DivIcon = L.Icon.extend({
        options: {
            iconSize: [6, 6], // also can be set through CSS
            /*
            iconAnchor: (Point)
            popupAnchor: (Point)
            html: (String)
    ...
    */
    ...
    L.Draggable = L.Class.extend({
        ...
        _onDown: function (e) {
            if ((e.shiftKey || mapToolMode == ToolMode.zoom) || ((e.which !== 1) && (e.button !== 1) && !e.touches)) { return; }
    ...
    */
    ...
    L.Map.BoxZoom = L.Handler.extend({
        ...
        _onMouseDown: function (e) {
            if (!(e.shiftKey|| mapToolMode==ToolMode.zoom) || ((e.which !== 1) && (e.button !== 1))) { return false; }
