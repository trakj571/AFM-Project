...
var msgBoxImagePath = "libs/msgbox/";
...
function msg (options) {
    ...
    if (options.type == "prompt") {
        $("#MsgBox").html(divBackGround + "<div id=" + divMsgBoxId + " class=\"msgBox\">" + divTitle + "<div>" + divContainer + (options.showButtons ? divButtons + "</div>" : "</div>") + "</div>");
