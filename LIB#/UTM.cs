...
namespace EBMSMap30
{
    ...
    */
        ...
        *
        */
        private void MapXYToLatLon(double x, double y, double lambda0, double[] philambda)
        {
    ...
    */
        ...
        *
        */
        public void UTMXYToLatLon(double x, double y, double zone, bool southhemi, double[] latlon)
        {
            double cmeridian;
